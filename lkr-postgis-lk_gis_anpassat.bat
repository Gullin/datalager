...
SET DL_PROCESSNAME=lkr-postgis-lk_gis_anpassat
REM Processlokala parametrar
SET DL_OUTDIR=landskrona\lk_gis\anpassat
SET DL_OUTDBSCHEMA=data_auto_landskrona_lk_gis_anpassat
SET DL_FMEPROCESS01="%DL_PROCESSNAME%\_fme\postgis-lk_gis_anpassat-DatalagerManage.fmw"
