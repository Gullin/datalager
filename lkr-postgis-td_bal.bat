...
SET DL_PROCESSNAME=lkr-postgis-td_bal
REM Processlokala parametrar
SET DL_OUTDIR=landskrona\td_bal
SET DL_OUTDBSCHEMA=data_auto_landskrona_td_bal
SET DL_FMEPROCESS01="%DL_PROCESSNAME%\_fme\postgis-td_bal-DatalagerManage-driver.fmw"
