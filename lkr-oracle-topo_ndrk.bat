...
SET DL_PROCESSNAME=lkr-oracle-topo_ndrk
REM Processlokala parametrar
SET DL_OUTDIR=landskrona\topo_ndrk
SET DL_FMEPROCESS01="%DL_PROCESSNAME%\_fme\oracle-topo_ndrk-DatalagerManage-driver.fmw"
...
IF %ERRORLEVEL% EQU 0 (
    ...
    @CALL _sys\_schema-driver %DL_PROCESSNAME% %DL_ISWHOLEPROCESS% validate NULL ORACLE_SPATIAL TOPO_NDRK
