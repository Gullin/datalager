...
SET DL_PROCESSNAME=lkr-postgis-flex_grund_anpassat
REM Processlokala parametrar
SET DL_OUTDIR=landskrona\flex_grund\anpassat
SET DL_OUTDBSCHEMA=data_auto_landskrona_flex_grund_anpassat
SET DL_FMEPROCESS01="%DL_PROCESSNAME%\_fme\postgis-flex_grund_anpassat-DatalagerManage-driver.fmw"
...
IF %ERRORLEVEL% EQU 0 (
    ...
    @CALL _sys\_schema-driver %DL_PROCESSNAME% %DL_ISWHOLEPROCESS% validate NULL false POSTGIS PG_FLEX
