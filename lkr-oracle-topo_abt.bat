...
SET DL_PROCESSNAME=lkr-oracle-topo_abt
REM Processlokala parametrar
SET DL_OUTDIR=landskrona\topo_abt\
SET DL_FMEPROCESS01="%DL_PROCESSNAME%\_fme\oracle-topo_abt-DatalagerManage-driver.fmw"
...
IF %ERRORLEVEL% EQU 0 (
    ...
    @CALL _sys\_schema-driver %DL_PROCESSNAME% %DL_ISWHOLEPROCESS% validate NULL ORACLE_SPATIAL TOPO_ABT
