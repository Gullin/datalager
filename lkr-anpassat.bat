...
SET DL_DIRPLANDOKUMENT3RD="\\admsrv0118.adm.landskrona.local\d$\Dokument\Plan\plandokument"
@REM SET DL_DIRPLANDOKUMENT="C:\temp\plandokument\pdf"
@REM SET DL_DIRPLANDOKUMENT3RD="C:\temp\plandokument\pdf3rd"
...
IF %ERRORLEVEL% EQU 0 (
    ...
    @CALL _sys\_schema-driver %DL_PROCESSNAME% %DL_ISWHOLEPROCESS% validate NULL false
...
:ManageSourceDatalager
    ...
    >nul (
        @%DL_FMEFULLPATH% %DL_FMEPROCESS01% ^
                            ...
                            --PlandokumentDir3Rd  %DL_DIRPLANDOKUMENT3RD%
    )
