...
SET DL_PROCESSNAME=lkr-postgis-td_bal_anpassat
REM Processlokala parametrar
SET DL_OUTDIR=landskrona\td_bal\anpassat
SET DL_OUTDBSCHEMA=data_auto_landskrona_td_bal_anpassat
SET DL_FMEPROCESS01="%DL_PROCESSNAME%\_fme\postgis-td_bal_anpassat-DatalagerManage.fmw"
