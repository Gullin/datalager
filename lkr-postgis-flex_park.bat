...
SET DL_PROCESSNAME=lkr-postgis-flex_park
REM Processlokala parametrar
SET DL_OUTDIR=landskrona\flex_park
SET DL_OUTDBSCHEMA=data_auto_landskrona_flex_park
SET DL_FMEPROCESS01="%DL_PROCESSNAME%\_fme\postgis-flex_park-DatalagerManage-driver.fmw"
