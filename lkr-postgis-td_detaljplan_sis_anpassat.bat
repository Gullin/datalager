...
SET DL_PROCESSNAME=lkr-postgis-td_detaljplan_sis_anpassat
REM Processlokala parametrar
SET DL_OUTDIR=landskrona\td_detaljplan_sis\anpassat
SET DL_OUTDBSCHEMA=data_auto_landskrona_td_detaljplan_sis_anpassat
SET DL_FMEPROCESS01="%DL_PROCESSNAME%\_fme\postgis-td_detaljplan_sis_anpassat-DatalagerManage.fmw"
