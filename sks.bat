...
SET DL_PROCESSNAME=sks
REM Processlokala parametrar
SET DL_OUTDIR=sks
SET DL_OUTDBSCHEMA=data_auto_sks
SET DL_FMEPROCESS01="_sys\_download-http-caller.fmw"
SET DL_FMEPROCESS02="%DL_PROCESSNAME%\_fme\sks-DatalagerManage-driver.fmw"
...
IF %ERRORLEVEL% EQU 0 (
    ...
    @CALL _sys\_schema-driver %DL_PROCESSNAME% %DL_ISWHOLEPROCESS% validate NULL false OGCGEOPACKAGE
