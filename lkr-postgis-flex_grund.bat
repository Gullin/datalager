...
SET DL_PROCESSNAME=lkr-postgis-flex_grund
REM Processlokala parametrar
SET DL_OUTDIR=landskrona\flex_grund
SET DL_OUTDBSCHEMA=data_auto_landskrona_flex_grund
SET DL_FMEPROCESS01="%DL_PROCESSNAME%\_fme\postgis-flex_grund-DatalagerManage-driver.fmw"
