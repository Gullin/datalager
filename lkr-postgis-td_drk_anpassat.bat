...
SET DL_PROCESSNAME=lkr-postgis-td_drk_anpassat
REM Processlokala parametrar
SET DL_OUTDIR=landskrona\td_drk\anpassat
SET DL_OUTDBSCHEMA=data_auto_landskrona_td_drk_anpassat
SET DL_FMEPROCESS01="%DL_PROCESSNAME%\_fme\postgis-td_drk_anpassat-DatalagerManage.fmw"
