...
SET DL_PROCESSNAME=lkr-oracle-topo_bal
REM Processlokala parametrar
SET DL_OUTDIR=landskrona\topo_bal
SET DL_FMEPROCESS01="%DL_PROCESSNAME%\_fme\oracle-topo_bal-DatalagerManage-driver.fmw"
...
IF %ERRORLEVEL% EQU 0 (
    ...
    @CALL _sys\_schema-driver %DL_PROCESSNAME% %DL_ISWHOLEPROCESS% validate NULL ORACLE_SPATIAL TOPO_BAL
