...
SET DL_PROCESSNAME=lkr-postgis-td_baskarta_anpassat_markdetaljtyp
REM Processlokala parametrar
SET DL_OUTDIR=landskrona\td_baskarta\anpassat\markdetaljtyp
SET DL_OUTDBSCHEMA=data_auto_landskrona_td_baskarta_anpassat_markdetaljtyp
SET DL_FMEPROCESS01="%DL_PROCESSNAME%\_fme\postgis-td_baskarta_anpassat_markdetaljtyp-DatalagerManage-driver.fmw"
...
IF %ERRORLEVEL% EQU 0 (
    ...
    @CALL _sys\_schema-driver %DL_PROCESSNAME% %DL_ISWHOLEPROCESS% validate NULL false POSTGIS PG_GEODATA
