...
SET DL_PROCESSNAME=lkr-postgis-flex_gata
REM Processlokala parametrar
SET DL_OUTDIR=landskrona\flex_gata
SET DL_OUTDBSCHEMA=data_auto_landskrona_flex_gata
SET DL_FMEPROCESS01="%DL_PROCESSNAME%\_fme\postgis-flex_gata-DatalagerManage-driver.fmw"
