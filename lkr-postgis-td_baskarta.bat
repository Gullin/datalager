...
SET DL_PROCESSNAME=lkr-postgis-td_baskarta
REM Processlokala parametrar
SET DL_OUTDIR=landskrona\td_baskarta
SET DL_OUTDBSCHEMA=data_auto_landskrona_td_baskarta
SET DL_FMEPROCESS01="%DL_PROCESSNAME%\_fme\postgis-td_baskarta-DatalagerManage-driver.fmw"
