...
REM Argument 2: Suffix p† fil f”r schema-dokumentationen (standardsuffix "flush", f”r att inte skriva ”ver en ev. init-fil).
...
REM             Validering mellan k”rningar g”rs med "init" eller "manifest" mot "flush".
REM Argument 3: Dataset vars schema-struktur ska l„sas av. F”r filer anges s”kv„g och f”r databas anges det namn i FME som definierar anslutningen.
...
REM Argument 5: Tabeller, anv„nds n„r datasetet „r en databas f”r tabellnamn. Flera tabellnamn listas med mellanrum som separator och
...
SET DL_FMEPROCESS01="_sys\_schema.fmw"
...
:SchemaInit
    ...
    @%DL_FMEFULLPATH% %DL_FMEPROCESS01% ^
                        ...
                        --InData %_arg3% ^
                        --InData-DatabasTable %_arg5% ^
                        --DataFormat %_arg4% ^
                        --OutSchemaFileNameSuffix %_arg2%^
