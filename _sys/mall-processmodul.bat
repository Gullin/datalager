...
SET DL_PROCESSNAME=<#PROCESSMODULSNAMN#>
REM Processlokala parametrar
SET DL_OUTDIR=<#S™KVŽG TILL UTKATALOG F™R DATA#>
SET DL_OUTDBSCHEMA=<#SSCHEMANAMN F™R DATA TILL DATABAS#>
SET DL_FMEPROCESS01=<#FME-PROCESSER SOM ANVŽNDS,"%DL_PROCESSNAME%\_fme\fme-process.fmw"#>
...
IF %ERRORLEVEL% EQU 0 (
    ...
    @CALL _sys\_schema-driver %DL_PROCESSNAME% %DL_ISWHOLEPROCESS% validate <#NULL true ORACLE_SPATIAL LKR_GIS#>
