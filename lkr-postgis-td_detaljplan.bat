...
SET DL_PROCESSNAME=lkr-postgis-td_detaljplan
REM Processlokala parametrar
SET DL_OUTDIR=landskrona\td_detaljplan
SET DL_OUTDBSCHEMA=data_auto_landskrona_td_detaljplan
SET DL_FMEPROCESS01="%DL_PROCESSNAME%\_fme\postgis-td_detaljplan-DatalagerManage-driver.fmw"
